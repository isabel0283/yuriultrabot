        ...
        switch (text) {
            ...
            case "youtubeYuri":
             ...
             case "weatherYuri":
                ...
                //Urls of icons
                String cloudIconurl = "http://openweathermap.org/img/wn/" + yourCloudicon + "@2x.png?_ignored=";
                String flagIconurl = "http://openweathermap.org/images/flags/" + yourCountry + ".png?_ignored=";
                //Building the report
